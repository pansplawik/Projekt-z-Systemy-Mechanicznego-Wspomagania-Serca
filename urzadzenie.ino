...
void setup()
{
  ...
  {
    MyBlue.println("MAX30102 was not found. Please check wiring/power/solder jumper at MH-ET LIVE MAX30102 board. ");
    while (1);
  }
...
double ESpO2 = 99.0;//initial value of estimated SpO2
...
//        float red_forGraph = (2.0 * fred - avered) / avered * SCALE;
       ...
       // to display pulse wave at the same time with SpO2 data
        
        MyBlue.println(ESpO2); //low pass filtered SpO2
